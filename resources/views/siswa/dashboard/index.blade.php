    ...
    <section id="tagihan" class="my-5">
                    ...
                    <div class="col-md-6 mb-2">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-text">Rp. {{ number_format($total_tagihan_belum_dibayar, 0, ',', '.') }}
                                </h3>
                            </div>
                        </div>
                    </div>
        ...
        <div class="accordion" id="accordionExample">
            ...
            <div class="accordion-item">
                ...
                <div id="collapse{{ $tahun }}" class="accordion-collapse collapse" aria-labelledby="heading{{ $tahun }}"
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-3">
                                <div class="card h-100">
                                    <div class="card-body">
                                        ...
                                        <button type="button" class="btn btn-success btn-sm" title="Bayar"
                                            data-bs-toggle="modal" data-bs-target="#updateModal"
                                            data-bs-nis="{{ Auth::user()->nis }}" data-bs-bulan="{{ $bulan }}"
                                            data-bs-tahun="{{ $tahun }}" data-bs-bayar="{{ $jumlah_tagihan }}">
                                            <i class="fas fa-dollar"></i> Bayar
                                        </button>
                                        @endif
                                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="date" class="form-control" id="tanggal_bayar" value="{{ date('Y-m-d') }}"
                                name="tanggal_bayar">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" accept="image/png, image/jpg, image/jpeg" class="form-control" id="foto"
                            name="foto">
                    </div>
                    <div class="mb-3">
