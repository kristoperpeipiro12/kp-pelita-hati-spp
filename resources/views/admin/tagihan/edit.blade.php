            ...
            <div class="col-lg-12">
                ...
                <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-dark">Edit Tagihan</h6>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('tagihan.update', $tagihan->kelas) }}" method="POST"
                            ...
                            <div class="hts-con-form-group">
                                <div class="form-group w-100">
                                    ...
                                    <select class="form-control" id="kelas" name="kelas">
                                        ...
                                        @for ($i = 1; $i <= 6; $i++)
                                            <option value="{{ $i }}"
                                                {{ $tagihan->kelas == $i ? 'selected' : '' }}> {{ $i }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="form-group w-100">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="tagihan_perbulan" id="numberInput"
                                            value="{{ $tagihan->tagihan_perbulan }}" autocomplete="off">
                                    </div>
                                </div>
                            </div>
