                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center">
                                                <a href="{{ route('pengeluaran.edit', $keluar->id_pengeluaran) }}" class="btn btn-primary btn-sm mr-2"><i class="fas fa-pen-alt"></i></a>
                                                <button type="button" class="btn btn-danger btn-sm ml-2" data-toggle="modal" data-target="#deleteModal{{ $keluar->id_pengeluaran }}">
                                                    <i class="fas fa-trash-alt"></i>
                                                </button>
                                            </td>
                                        </tr>
                                        <!-- Modal Delete -->
                                        <div class="modal fade" id="deleteModal{{ $keluar->id_pengeluaran }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
