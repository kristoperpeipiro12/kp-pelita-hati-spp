            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="row align-items-center justify-content-between mb-3">
                        ...
                        <div class="col-lg-1">
                            <button type="button" class="btn btn-info" title="Tambah" data-toggle="modal" data-aksi="tambah" data-tanggal="{{ date('Y-m-d') }}" data-title="Tambah Data" data-target="#modalForm">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex list-unstyled align-items-center justify-content-center">
                                                    <li>
                                                        <button type="button" class="btn btn-warning btn-sm" title="Ubah" data-aksi="ubah" data-title="Tambah Data" data-toggle="modal" data-target="#modalForm" data-id="{{ $row->id }}" data-judul="{{ $row->judul }}" data-info="{{ $row->info }}" data-tampil="{{ $row->tampil }}" data-tanggal="{{ $row->tanggal }}">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                                    </li>
                                                    <li>
                                                        <button type="button" class="btn btn-danger btn-sm ml-1" title="Hapus" data-toggle="modal" data-target="#deleteModal" data-id="{{ $row->id }}">
