    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            <div class="card-header d-flex flex-row align-items-center justify-content-between">
                ...
                <a href="{{ route('user.create') }}" class="btn btn-info mb-1"><i class="fas fa-plus" style="margin-right: 5px;"></i>Tambah</a>
            </div>
            <div class="card-body">
                    ...
                    <table class="table align-items-center table-flush table-hover" id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width: 40%;">{{ str_repeat('*', strlen($item->password)) }}</td>
                                <td>{{ $item->role }}</td>

                                <td class="text-center">
                                    <a href="{{ route('user.edit', $item->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-pen-alt"></i></a>
