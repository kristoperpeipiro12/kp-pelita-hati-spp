                    ...
                    <form action="{{ route('admin.siswa.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="hts-con-form-group">
                            <div class="form-group w-100">
                                ...
                                <input type="text" class="form-control" name="nis" placeholder="Nomor Induk Siswa"
                                    id="nis" autocomplete="off" value="{{ old('nis') }}">
                            ...
                            <div class="form-group w-100">
                                ...
                                <input type="text" class="form-control" name="nama" placeholder="Nama Siswa/i" id="nama"
                        ...
                        <div class="hts-con-form-group">
                            ...
                            <div class="form-group w-100">
                                ...
                                <input type="tel" class="form-control" name="nohp" placeholder="" id="nohp"
                        ...
                        <div class="hts-con-form-group">
                            ...
                            <div class="form-group w-100">
                                ...
                                <input type="text" class="form-control" name="alamat" id="alamat" autocomplete="off"
                                    placeholder="Nama Jalan, Nama Komp, Nomor Rumah" value="{{ old('alamat') }}">
                                @error('alamat')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
