    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.siswa.store') }}" method="POST" enctype="multipart/form-data" class="d-flex flex-column">
                        @csrf
                        <div class="hts-con-form-group">
                            ...
                            <div class="form-group w-100">
                                ...
                                <input type="text" class="form-control" name="nama" placeholder="Nama Siswa/i" id="nama" autocomplete="off" value="{{ old('nama') }}">
                                @error('nama')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="hts-con-form-group">
                            <div class="form-group w-100">
                                ...
                                <input type="text" class="form-control" name="alamat" id="alamat" autocomplete="off" placeholder="Jl. Veteran" value="{{ old('alamat') }}">
                                @error('alamat')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="hts-con-form-group">
                            <div class="form-group w-100">
                                ...
                                <input type="tel" class="form-control" name="nohp" placeholder="" id="nohp" autocomplete="off" value="{{ old('nohp') }}">
