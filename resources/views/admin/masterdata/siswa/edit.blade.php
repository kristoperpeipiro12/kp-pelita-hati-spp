    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.siswa.update',$siswa->nis) }}" method="POST" enctype="multipart/form-data" class="d-flex flex-column">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="hts-con-form-group">
                            <div class="form-group w-100">
                                ...
                                <select class="form-control" name="kelas">
                                    ...
                                    @for ($i = 1; $i <= 6; $i++) <option value="{{ $i }}" {{ $siswa->kelas == $i ? 'selected' : '' }}>{{ $i }}</option>
                                        @endfor
                                </select>
                            </div>
                            <div class="form-group w-100">
