            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        {{-- edit area --}}
                        <div class="hpem-head-index">
                            <div class="w-50">
                                <div class="w-100">
                                    <label for="filterJenisTransaksi" class="d-flex align-items-center mt-2 mr-2">Jenis
                                        Transaksi</label>
                                    <select id="filterJenisTransaksi" class="form-control form-control-sm w-100"
                                        style="width: 120px;">
                                ...
                                <div class="w-100">
                                    ...
                                    <select id="filterKonfirmasi" class="form-control form-control-sm w-100"
                                        style="width: 120px;">
                                        <option value="">Semua</option>
                                        @php
                            ...
                            <div class="hpem-btn-tambah w-50">
                                        ...
                                        <tbody>
                                            @foreach ($pemasukan as $p)
                                                <tr class="overflow-scroll">
                                                        ...
                                                        <div
                                                            ...
                                                            <li>
                                                                <button type="button" class="btn btn-success btn-sm"
                                                                    title="Konfirmasi" data-toggle="modal"
                                                                    data-target="#updateModal" data-id="{{ $p->id }}"
                                                                    data-konfirmasi="{{ $p->konfirmasi }}">
                                                                    <xi class="fas fa-check"></xi>
                                                                </button>
                                                            </li>
                                                            <li>
                                                                <a href="{{ route('pemasukan.edit', $p->id) }}"
                                                                    title="Ubah" class="btn btn-warning btn-sm ml-1">
                                                    ...
                                                    <td>{{ \Carbon\Carbon::parse($p->tanggal_bayar)->format('d-m-Y') }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="{{ $p->foto ? asset('storage/Bukti-transfer/' . $p->foto) : '' }}"
                                                            data-fancybox="gallery">
                                                            <img src="{{ $p->foto ? asset('storage/Bukti-transfer/' . $p->foto) : '' }}"
                                                                alt="" width="65">
                                                        </a>
                                                    </td>
                                                </tr>
