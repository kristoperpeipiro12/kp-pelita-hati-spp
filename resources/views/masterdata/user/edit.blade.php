...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h3 class="h3 mb-0 text-gray-500">Edit User</h3>
    </div>
                    ...
                    <form action="{{ route('user.update', $user->id) }}" method="POST" class="d-flex flex-column">
                        ...
                        <div class="hts-con-form-group">
                            <div class="form-group w-100">
                                ...
                                <input type="text" class="form-control @error('username') is-invalid @enderror" name="username" placeholder="Nama Pengguna" id="nama_user" value="{{ $user->username }}">
                                @error('username')
